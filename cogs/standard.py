"""
Standard episode type, based on AI Sponge Rehydrated standard topics.
...
music_stars_and_games = low_pass_filter(high_pass_filter(AudioSegment.from_wav("audio/music/stars_and_games.wav"), cutoff_filter), cutoff_filter)
...
# SFX audio segments
sfx_random = {
    AudioSegment.from_wav("audio/sfx/random/steel_sting.wav"): 10,
    AudioSegment.from_wav("audio/sfx/random/boowomp.wav"): 10,
    ...
    AudioSegment.from_wav("audio/sfx/random/honk.wav"): 5,
    ...
    AudioSegment.from_wav("audio/sfx/random/kick_1.wav"): 5,
    AudioSegment.from_wav("audio/sfx/random/kick_2.wav"): 5,
    AudioSegment.from_wav("audio/sfx/random/kick_3.wav"): 5,
    AudioSegment.from_wav("audio/sfx/random/squish_1.wav"): 5,
    AudioSegment.from_wav("audio/sfx/random/squish_2.wav"): 5,
    AudioSegment.from_wav("audio/sfx/random/explosion.wav"): 5,
    ...
    AudioSegment.from_wav("audio/sfx/random/foghorn_1.wav"): 1,
    AudioSegment.from_wav("audio/sfx/random/foghorn_2.wav"): 1,
...
class Standard(GroupCog, name="standard", description="Generate episodes, TTS, and chats based on standard topics."):
    ...
    async def tts(self, interaction: Interaction, character: characters, text: Range[str, char_limit_min, char_limit_max], megaphone: bool = False, loud: bool = False):
        ...
        :param megaphone: Whether to speak through a megaphone
